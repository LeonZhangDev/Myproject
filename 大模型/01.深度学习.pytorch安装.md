...
<img src='media/image-20240826091020863.png'/>
...
<img src='media/image-20250604110922406.png'/>'

### 3.2 安装cuDNN(本阶段可不安装)

官网地址：[cuDNN Archive | NVIDIA Developer](https://developer.nvidia.com/rdp/cudnn-archive)，需要先注册账号(使用邮箱注册即可)，这里安装的是8.9.7版本
